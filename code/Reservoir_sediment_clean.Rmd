...
Section 2: Sediment data analysis for whole-ecosystem samples. Formats data for subsequent sections and exports a graph that compares sediment to sedimentation traps.
```{r}
