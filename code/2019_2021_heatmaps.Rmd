...
do = do%>%
  ...
  filter(!is.na(DO_mgL),
         Site == 50,
         (Date>=as.Date("2018-03-01")&Date<as.Date("2018-12-01"))|
           (Date>as.Date("2019-03-01")&Date<as.Date("2019-12-01"))|
           (Date>as.Date("2020-03-01")&Date<as.Date("2020-12-01"))|
...
#Interpolate to get values at all depths and dates
do_fcr_2018_interp <- interp2xyz(interp(do_fcr_2018$Date,do_fcr_2018$Depth_m,do_fcr_2018$DO_mgL,xo = seq(min(do_fcr_2018$Date), max(do_fcr_2018$Date),1 ),yo = seq(min(do_fcr_2018$Depth_m), max(do_fcr_2018$Depth_m), by = .01), duplicate = "mean"),data.frame = T)
...
do_fcr_2020_interp <- interp2xyz(interp(do_fcr_2020$Date,do_fcr_2020$Depth_m,do_fcr_2020$DO_mgL,xo = seq(min(do_fcr_2020$Date), max(do_fcr_2020$Date),1 ),yo = seq(min(do_fcr_2020$Depth_m), max(do_fcr_2020$Depth_m), by = .01), duplicate = "mean"),data.frame = T)
...
do_bvr_2018_interp <- interp2xyz(interp(do_bvr_2018$Date,do_bvr_2018$Depth_m,do_bvr_2018$DO_mgL,xo = seq(min(do_bvr_2018$Date), max(do_bvr_2018$Date), 1),yo = seq(min(do_bvr_2018$Depth_m), max(do_bvr_2018$Depth_m), by = .01), duplicate = "mean"),data.frame = T)
...
do_bvr_2020_interp <- interp2xyz(interp(do_bvr_2020$Date,do_bvr_2020$Depth_m,do_bvr_2020$DO_mgL,xo = seq(min(do_bvr_2020$Date), max(do_bvr_2020$Date), 1),yo = seq(min(do_bvr_2020$Depth_m), max(do_bvr_2020$Depth_m), by = .01), duplicate = "mean"),data.frame = T)
...
```{r}
interp_do = #do_fcr_2018_interp%>%
  do_fcr_2019_interp%>%
  full_join(do_fcr_2020_interp)%>%
  full_join(do_fcr_2021_interp)%>%
  mutate(Reservoir = "FCR")%>%
  #full_join(do_bvr_2018_interp%>%mutate(Reservoir="BVR"))%>%
  full_join(do_bvr_2019_interp%>%mutate(Reservoir="BVR"))%>%
  full_join(do_bvr_2020_interp%>%mutate(Reservoir="BVR"))%>%
  full_join(do_bvr_2021_interp%>%mutate(Reservoir="BVR"))%>%
