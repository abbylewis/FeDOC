...
df.final.new%>%filter(!is.na(method))
...
interp_do%>%
  ...
  ggplot(aes(x = x, y = y, color = Reservoir))+
  geom_point()+
...
interp_do_box%>%
  ...
  geom_vline(xintercept = as.factor(2019), cex = 12, color = "gray", alpha = 0.5)+
