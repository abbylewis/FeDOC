...
```{r}
#Load data
calcs_raw = read_excel("../data/processed_data/Calculations_23May22.xlsx")
calcs = calcs_raw%>%
  #Create simple column names
  select("sample ID","Type","% OC loss AKA Fe-OC as % of sediment OC","Corrected %C","Extractable  Carbon in umol/g (i.e. Fe-OC per sediment mass in umol/g)","rerun")%>%
