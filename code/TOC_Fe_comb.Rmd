...
formatted$name <- factor(formatted$name, levels = c("DO_mgL", "NPOC", "Filtered", "Unfiltered"))
...
jpeg("../figures/combined_exp_graph_full.jpg", width = 8, height = 8, units = "in",res = 300)
f
dev.off()
```
