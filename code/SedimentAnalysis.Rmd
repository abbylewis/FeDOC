...
fedoc <- read_csv("../data/raw_data/ASL14dec21.csv")
...
write.csv(fedoc_filt, "../data/processed_data/14dec21_formatted.csv", row.names = F)
...
```{r}
calcs_raw = read_excel("../data/processed_data/Calculations 7Dec21.xlsx", sheet = "calculations")
...
# Average Fe-OC across 2019 and 2021: (31.4*7+35.78*19)/(19+7)
```
