...
Section 2: Calculated volume-weighted means
...
Section 5: Simple metals and DOC graphs
This section graphs Fe and DOC as functions of dissolved oxygen concentrations.
```{r}
#IRON
...
summary(lm(lowest_comb$DOC_mgL~lowest_comb$TFe_mgL*lowest_comb$Reservoir))
```
